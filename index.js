  ...
  if (!message.member.permissions.has(PermissionsBitField.Flags.Administrator)) return;
       ...
       if (message.content === "!verify") {
        ...
        const bannerEmbed = {
            color: 0x1e1f22,
            image: {
                url: "https://media.discordapp.net/attachments/1467765239398269111/1468347228501311528/1762231950_87c158f8-b75a-4ecd-86a8-c3caecc52c98.gif?ex=6983b06b&is=69825eeb&hm=5c551ece37f165fb1858fe1ab69bc7f09adcbcadbdd11ff49c41aaab6d222fb5&=" // GIF grande de arriba
            }
        };
        ...
        const verifyEmbed = {
            color: 0x1e1f22,
            description: `
<:Invisible:1468160213923401917><:Invisible:1468160213923401917><:Invisible:1468160213923401917><:Invisible:1468160213923401917><:Invisible:1468160213923401917>𓂃 ࣪˖ <a:Amulet:1468348992969507038>
<:Invisible:1468160213923401917> <a:Corazones:1468352540851830916> You get <@&1468297420298387487>
<:Invisible:1468160213923401917><:Invisible:1468160213923401917> <a:Corazones:1468352540851830916> __Press verify to start__
            `,
            image: {
                url: "https://cdn.discordapp.com/attachments/1467765239398269111/1468353882311884933/monchrome.gif?ex=6983b69e&is=6982651e&hm=ccdb2a1194b9f9b2c59a1406d6b7aa3137a4414d81cf191fcbb1a5ca4a5d6b0c" // ← ESTE ES EL GIF DE LA LÍNEA
            }
        };
